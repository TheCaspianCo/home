...
(async function() {
        ...
        <section class="section">
          <div class="container">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px;">
              ...
              <a href="/category/?category=${category.id}" class="btn btn-secondary">View all</a>
            </div>
  ...
  function renderProductCard(product) {
    const firstImage = product.images && product.images[0] ? product.images[0] : '/assets/placeholder.jpg';
    ...
    searchInput.addEventListener('input', function(e) {
      ...
      searchTimeout = setTimeout(() => {
        ...
        if (query.length >= 2) {
          ...
          window.location.href = `/picks/?search=${encodeURIComponent(query)}`;
        }
      }, 500);
    });
